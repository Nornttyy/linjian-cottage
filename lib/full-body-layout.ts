...
export const FULL_BODY_SHEETS=BODY_FAMILIES.flatMap(family=>BODY_ACTION_PAIRS.map(actions=>({family,actions,file:`body-${family}-${actions.join('-')}-v${family==='swim'?3:2}.png`})));
