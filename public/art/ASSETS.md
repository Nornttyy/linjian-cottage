...
| campfire-v2.png | 固定石圈木柴底座、八帧独立火焰 | 4列3行；首行只取第一个底座，第二、三行为火焰 |
...
营火使用内置图片生成功能重新生成的分层原图。游戏以同一个底座合成八帧火焰，各帧使用相同比例和固定火根位置，避免石圈与木柴跟着火焰变形。旧 objects-final.png 中的营火帧不再用于动画。
